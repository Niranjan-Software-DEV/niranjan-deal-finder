...
export const metadata: Metadata = {
  title: { default: 'Niranjan Deal Finder', template: '%s — Niranjan Deal Finder' },
      ...
      <body className="min-h-full flex flex-col bg-[#f5f4ef] text-[#171a16]">
        ...
        <header className="sticky top-0 z-20 border-b border-[#dfe1d8]/90 bg-[#f5f4ef]/90 backdrop-blur-xl">
          <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:h-[72px] sm:px-8">
            <Link href="/" className="group flex items-center gap-3" aria-label="Niranjan Deal Finder home">
              ...
              <span className="block min-w-0">
                <span className="block truncate text-[12px] font-bold tracking-[-0.02em] text-[#171a16] sm:text-[13px]">Niranjan Deal Finder</span>
            ...
            <div className="flex items-center gap-2.5 sm:gap-3">
              <a
                href="https://github.com/Niranjan-Software-DEV/niranjan-deal-finder"
                target="_blank"
