...
async def lifespan(app: FastAPI):
    logger.info(
        "Niranjan Deal Finder starting | env=%s scraperapi=%s scrapingant=%s brightdata=%s",
    ...
    yield
    await close_browser()
    logger.info("Niranjan Deal Finder shutting down")


# ── App ───────────────────────────────────────────────────────────────────────
app = FastAPI(
    title="Niranjan Deal Finder API",
    version="2.2.0",
    description=(
